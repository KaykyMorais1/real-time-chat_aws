...
const URL = 'wss://sjmvej6pb3.execute-api.us-east-2.amazonaws.com/production/';
...
const App = () => {
  ...
  //Conexão com o Websocket e primeira interação com o usuario (setName)
  const onSocketOpen = useCallback(() => {
    ...
    if (name !== null && name !== "") {
      ...
      socket.current?.send(JSON.stringify({ action: 'setName', name:'Anônimo' }));
    }
  }, []);

  //Desconexão com o WebSocket
  ...
  //Método para chamar as funções do WebSocket
